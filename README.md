...
Le son démarre après une interaction. Le bouton **SON** coupe musique et bruitages et mémorise votre préférence. Quitter la fenêtre met le jeu en pause. Les commandes tactiles ne sont pas implémentées.
