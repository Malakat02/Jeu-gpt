...
stick.fire('pointerdown',1,128,64);assert.equal(c.x,0,'initial touch is neutral');assert.equal(c.y,0);stick.fire('pointermove',1,190,64);assert.equal(c.x,1);
